          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Form Edit Data Gelanggang</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Form Edit Data Gelanggang</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-8">
          ...
          <div class="card">
            <div class="card-header">
              <h5>Form Edit Data Gelanggang</h5>
            </div>
            <div class="card-body">
              <form action="{{ route('managegelanggang.update', $gelanggang->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      ...
                      <input type="text" name="nama_gelanggang" class="form-control @error('nama_gelanggang') is-invalid @enderror" 
                             placeholder="Masukkan nama gelanggang" value="{{ old('nama_gelanggang', $gelanggang->nama_gelanggang) }}" required>
                  ...
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      ...
                      <input type="text" name="lokasi_gelanggang" class="form-control @error('lokasi_gelanggang') is-invalid @enderror" 
                             placeholder="Masukkan lokasi gelanggang" value="{{ old('lokasi_gelanggang', $gelanggang->lokasi_gelanggang) }}" required>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      <label class="form-label">Gambar Gelanggang</label>
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="current-image">
                    <img src="{{ asset('image/gelanggang/' . $gelanggang->gambar) }}" alt="{{ $gelanggang->nama_gelanggang }}" 
                ...
                <div class="form-group mb-3">
                  ...
                  <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" 
                            rows="4" placeholder="Masukkan deskripsi gelanggang" required>{{ old('deskripsi', $gelanggang->deskripsi) }}</textarea>
                  @error('deskripsi')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
