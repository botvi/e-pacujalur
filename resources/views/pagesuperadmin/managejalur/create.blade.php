          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Form Tambah Data Jalur</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Form Tambah Data Jalur</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-8">
          ...
          <div class="card">
            <div class="card-header">
              <h5>Form Tambah Data Jalur</h5>
            </div>
            <div class="card-body">
              <form action="{{ route('managejalur.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      ...
                      <input type="text" name="nama_jalur" class="form-control @error('nama_jalur') is-invalid @enderror" 
                             placeholder="Masukkan nama jalur" value="{{ old('nama_jalur') }}" required>
                      @error('nama_jalur')
                  ...
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      ...
                      <input type="text" name="asal_jalur" class="form-control @error('asal_jalur') is-invalid @enderror" 
                             placeholder="Masukkan asal jalur" value="{{ old('asal_jalur') }}" required>
                      @error('asal_jalur')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      ...
                      <input type="text" name="tahun_buat" class="form-control @error('tahun_buat') is-invalid @enderror" 
                             placeholder="Contoh: 2024" value="{{ old('tahun_buat') }}" required>
                      @error('tahun_buat')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      <label class="form-label">Gambar Jalur <span class="text-danger">*</span></label>
                ...
                <div class="form-group mb-3">
                  ...
                  <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" 
                            rows="4" placeholder="Masukkan deskripsi jalur" required>{{ old('deskripsi') }}</textarea>
                  @error('deskripsi')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
